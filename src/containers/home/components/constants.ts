...
export const SYSTEM_LIST = [
	{
		...
		text: 'Easy to use interface to start an NFT Collection within minutes',
	},
	{
		title: 'Simplr Badges',
		text: 'Easy to use interface to create badges or membership access using ERC1155',
	},
	{
		title: 'Simplr Staking',
		text: 'Easy to use tool to give out staking rewards to the holders for staking',
	},
	{
		title: 'Simplr Airdrop',
		text: 'Easy to use tool to create and airdrop',
	},
	{
		title: 'Simplr Govern',
		text: 'Convert your NFT Communities into co-ordinating DAOs',
	},
];
